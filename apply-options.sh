...
# Replace line in config file using sed (target 72th line)
sed -i "72s/.*/        audio_backend_latency_offset_in_seconds = $quoted_value/" "$config_file"

################################################### mqtt setting ###################################################

# Get arguments
json_key="mqtt_enabled"
...
# Replace line in config file using sed (target 271th line)
...
# Replace line in config file using sed (target 272th line)
